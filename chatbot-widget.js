...
function startConversation() {
    fetch('https://chatbot-for-bear-creek-lodge-learning-center.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-bear-creek-lodge-learning-center.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbzrphpY7Qmq7aADizltFgGsmsfJrThd2lpDkg6VM95P1FfJLmGZS9V3Qnan1DUB4MI/exec';
